...
// フォント名を取得する
std::wstring DirectWrite::GetFontName(int num)
{
	// フォント名のリストが空だった場合
...
// フォント設定
// 第1引数：フォントデータ構造体
HRESULT DirectWrite::SetFont(FontData set)
{
	HRESULT result = S_OK;
...
//=================================================================================================================================
HRESULT DirectWrite::SetFont(WCHAR const* fontname, DWRITE_FONT_WEIGHT fontWeight, DWRITE_FONT_STYLE fontStyle,
...
// options：テキストの整形
//====================================
HRESULT DirectWrite::DrawString(std::string str, float posX, float posY, D2D1_DRAW_TEXT_OPTIONS options, bool shadow)
{
	HRESULT result = S_OK;
...
// options：テキストの整形
//====================================
HRESULT DirectWrite::DrawString(std::string str, D2D1_RECT_F rect, D2D1_DRAW_TEXT_OPTIONS options, bool shadow)
{
	HRESULT result = S_OK;
...
// 拡張子を除くファイル名を返す
WCHAR* DirectWrite::GetFontFileNameWithoutExtension(const std::wstring& filePath)
{
